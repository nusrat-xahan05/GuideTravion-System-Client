...
export default function TourCard({ tour, onDelete, userInfo }: TourCardProps) {
    ...
    // can send request if 'statusByAdmin===REQ_SEND'
    const canSendVerifyReq = (tour.statusByAdmin === TTourStatusByAdmin.REQ_SEND)

    // Don't display Send req box to admin if creator is not admin
    const canNotDisplay = (userInfo.role === TUserRole.ADMIN) && (userInfo._id !== tour.createdBy)

    const navigateRole = (userInfo.role === TUserRole.ADMIN) ? 'admin' : 'guide';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 rounded-xl border bg-white shadow-sm hover:shadow-lg transition-all p-4">
            ...
            <div className="flex flex-col justify-between flex-1 space-y-3 lg:col-span-2">
                ...
                <div className="flex justify-between">
                    ...
                    <div>
                        {!canNotDisplay && (tour.statusByAdmin === TTourStatusByAdmin.REQ_SEND) && (
                ...
                <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 pt-3 border-t mt-3">
                    ...
                    <div className="flex justify-end gap-2">
                        <Link href={`/${navigateRole}/dashboard/tours-management/${tour.slug}`}>
