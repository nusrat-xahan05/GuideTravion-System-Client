...
import CancelledBookingsHeader from "@/components/modules/Tourist/TouristCancelledBookings/CancelledBookingsHeader";
...
const TouristCancelledBookedTourPage = async ({ searchParams, }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }>; }) => {
...
export default TouristCancelledBookedTourPage;
