...
import UpcomingBookingsHeader from "@/components/modules/Guide/GuideUpcomingBookings/UpcomingBookingsHeader";
import BookingsTable from "@/components/modules/Guide/GuideBookings/BookingsTable";



const GuideUpcomingBookedTourPage = async ({ searchParams, }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }>; }) => {
...
export default GuideUpcomingBookedTourPage;
